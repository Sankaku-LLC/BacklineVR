...
namespace BacklineVR.Interaction
{
	...
	public class Throwable : MonoBehaviour
	{
		...
		public AttachmentFlags attachmentFlags = AttachmentFlags.ParentToHand | AttachmentFlags.DetachFromOtherHand | AttachmentFlags.TurnOnKinematic;
        ...
        public ReleaseStyle releaseVelocityStyle = ReleaseStyle.ShortEstimation;
        ...
        protected virtual void OnHandHoverBegin( Hand hand )
		{
            ...
            {
                float catchingThreshold = catchingSpeedThreshold * Player.Instance.Origin.lossyScale.x;
