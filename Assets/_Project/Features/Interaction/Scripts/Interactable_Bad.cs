...
{
    //-------------------------------------------------------------------------
    public class Interactable_Bad : MonoBehaviour
    {
        [Tooltip("Hide the controller part of the hand on attachment and show on detach")]
        public bool hideControllerOnAttach = false;

        public delegate void OnAttachedToHandDelegate(Hand_Bad hand);
        public delegate void OnDetachedFromHandDelegate(Hand_Bad hand);
        ...
        public Hand_Bad attachedToHand;

        [System.NonSerialized]
        public List<Hand_Bad> hoveringHands = new List<Hand_Bad>();
        public Hand_Bad hoveringHand
        {
            get
            {
        ...
        /// </summary>
        protected virtual void OnHandHoverBegin(Hand_Bad hand)
        {
        ...
        /// </summary>
        protected virtual void OnHandHoverEnd(Hand_Bad hand)
        {
            wasHovering = isHovering;
        ...
        protected virtual void OnAttachedToHand(Hand_Bad hand)
        {
        ...
        protected virtual void OnDetachedFromHand(Hand_Bad hand)
        {
